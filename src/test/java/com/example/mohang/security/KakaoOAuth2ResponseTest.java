...
class KakaoOAuth2ResponseTest {
    ...
    void givenMapFromJson_whenInstantiating_thenReturnsKakaoResponseObject() throws Exception {
        ...
        String serializedResponse = """
                {
                    "id": 1234567890,
                    "connected_at": "2023-11-25T00:12:34Z",
                    "properties": {
                        "nickname": "성노빈"
                    },
                    "kakao_account": {
        ...
        assertThat(result)
                ...
                .hasFieldOrPropertyWithValue("connectedAt", ZonedDateTime.of(2023, 11, 25, 0, 12, 34, 0, ZoneOffset.UTC)
                        .withZoneSameInstant(ZoneId.systemDefault())
                        .toLocalDateTime()
                )
                .hasFieldOrPropertyWithValue("kakaoAccount.profile.nickname", "성노빈")
