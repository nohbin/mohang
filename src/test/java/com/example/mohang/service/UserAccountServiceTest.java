...
class UserAccountServiceTest {
    ...
    void givenUserParams_whenSaving_thenSavesUserAccount() {
        // Given
        UserAccount userAccount = createUserAccount("nohbin");
        UserAccount savedUserAccount = createSigningUpUserAccount("nohbin");
